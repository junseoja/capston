// ============================================================
// [신규 2026-05-12 / frontend 브런치 머지 1단계]
// 출처: origin/frontend (e79a5be 이후 commit 8c9c6a2 "관리자 페이지 구현" + 62d5017 "신고 리스트 가독성 개선")
// 사유: 관리자 페이지 신규 추가. dev 경로 규칙(src/frontend/*)에 맞춰 src/AdminPage.jsx → src/frontend/AdminPage.jsx 로 이전.
// 기대효과: 관리자 대시보드/신고 처리/공지사항 작성 화면 사용 가능.
// 장점: 순수 표시 컴포넌트(props 주입형)라 dev의 백엔드 연결 코드와 분리되어 안전.
//        부모(App.jsx)에서 reports, onDeleteConfirm 만 주입하면 동작.
// ============================================================
