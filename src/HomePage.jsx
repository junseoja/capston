...
function HomePage({ routines, onCompleteCheck, onCompleteDetail }) {
  ...
  const getTimeTitle = () => {
    if (time === 'morning') return '🌅 아침 루틴'
    if (time === 'lunch') return '🍱 점심 루틴'
    return '🌙 저녁 루틴'
  }
  ...
  return (
    <div className="home">
      ...
      <div className="routine-content">
        <h2 className="home-section-title">{getTimeTitle()}</h2>
              ...
              >
                ...
                {routine.completed ? (
                  <div className="home-complete-box">
                    ...
                    {routine.proofText && (
                      <p className="home-proof-text">인증 내용: {routine.proofText}</p>
                    )}
                  </div>
                ) : (
                  <>
